...
const Lineup = ({ lineup, onDelete, onAdd, editingPos, cancelEdit, lineupYear, lineupWeek, lineupScore }) => {
  ...
  return (
    <div className="lineup">
        ...
        {lineup.rb2 ? <LineupPlayer player={lineup.rb2} position={'rb2'} beingEdited={checkBeingEdited('rb2')} onDelete={onDelete} onAdd={onAdd} /> 
          : <EmptyPlayer key={'rb2'} position={'rb2'} onAdd={onAdd} beingEdited={checkBeingEdited('rb2')} cancelEdit={cancelEdit} />}
        {lineup.wr1 ? <LineupPlayer player={lineup.wr1} position={'wr1'} beingEdited={checkBeingEdited('wr1')} onDelete={onDelete} onAdd={onAdd} /> 
          : <EmptyPlayer key={'wr1'} position={'wr1'} onAdd={onAdd} beingEdited={checkBeingEdited('wr1')} cancelEdit={cancelEdit} />}
        {lineup.wr2 ? <LineupPlayer player={lineup.wr2} position={'wr2'} beingEdited={checkBeingEdited('wr2')} onDelete={onDelete} onAdd={onAdd} /> 
          : <EmptyPlayer key={'wr2'} position={'wr2'} onAdd={onAdd} beingEdited={checkBeingEdited('wr2')} cancelEdit={cancelEdit} />}
        {lineup.wr3 ? <LineupPlayer player={lineup.wr3} position={'wr3'} beingEdited={checkBeingEdited('wr3')} onDelete={onDelete} onAdd={onAdd} /> 
          : <EmptyPlayer key={'wr3'} position={'wr3'} onAdd={onAdd} beingEdited={checkBeingEdited('wr3')} cancelEdit={cancelEdit} />}
        {lineup.te ? <LineupPlayer player={lineup.te} position={'te'} beingEdited={checkBeingEdited('te')} onDelete={onDelete} onAdd={onAdd} /> 
          : <EmptyPlayer key={'te'} position={'te'} onAdd={onAdd} beingEdited={checkBeingEdited('te')} cancelEdit={cancelEdit} />}
        {lineup.flex ? <LineupPlayer player={lineup.flex} position={'flex'} beingEdited={checkBeingEdited('flex')} onDelete={onDelete} onAdd={onAdd} /> 
